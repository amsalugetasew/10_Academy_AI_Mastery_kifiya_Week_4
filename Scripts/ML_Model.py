...
class ML_Model:
    ...
    def train_and_evaluate_pipeline(self,df, target_column, test_size=0.2, random_state=42, n_estimators=100, max_depth=None):
        ...
        # Example: Save a model or pipeline
        path_to_save = "regression_pipeline.pkl"

        # Assuming `pipeline` is your scikit-learn pipeline or model
        joblib.dump(pipeline, path_to_save)

        print(f"Pipeline saved to {path_to_save}")
